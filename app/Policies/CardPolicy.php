...
class CardPolicy
{
     ...
     */
    public function show(GlobalUser $user, Card $card): bool
    {
     ...
     */
    public function list(GlobalUser $user): bool
    {
     ...
     */
    public function create(GlobalUser $user): bool
    {
     ...
     */
    public function delete(GlobalUser $user, Card $card): bool
    {
